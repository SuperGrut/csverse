...
const TagsCarousel = () => {
  ...
  const tagsRow1 = [
    ...
    'Swift', 'Kotlin', 'Ruby', 'PHP', 'C#', 'Scala', 'Dart'
  ];
  
  const tagsRow2 = [
    'Machine Learning', 'Data Structures', 'Algorithms', 'Web Development', 
    'Mobile Apps', 'Cloud Computing', 'DevOps', 'Database Design', 
    'Networking', 'Security', 'Blockchain'
  ];
  
  const tagsRow3 = [
    'React', 'Angular', 'Vue.js', 'Node.js', 'Django', 'Flask', 'Spring Boot', 
    'TensorFlow', 'PyTorch', 'AWS', 'Docker', 'Kubernetes', 'GraphQL', 'Redux'
  ];
  ...
  useEffect(() => {
    ...
    const animate = (element, direction) => {
      ...
      const scrollAnimation = (timestamp) => {
        ...
        if (direction === 'right' && 
            element.current.scrollLeft >= element.current.scrollWidth - element.current.clientWidth) {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 mb-8">
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Browse our extensive library of computer science resources organized by programming languages, concepts, and frameworks
          </p>
        </div>
      </div>
