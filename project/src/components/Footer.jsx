        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold">CS Resources</span>
            </div>
            <p className="text-gray-300 mb-6">
              Discover and share the best computer science resources to advance your knowledge and skills.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors">Programming Languages</a>
              </li>
              <li>
              ...
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors">Data Structures</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors">Computer Science Theory</a>
              </li>
            </ul>
          </div>
